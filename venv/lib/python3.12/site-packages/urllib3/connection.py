...
class HTTPConnection(_HTTPConnection):
    """
    Based on :class:`http.services.HTTPConnection` but provides an extra constructor
    ...
    def host(self) -> str:
        ...
        In categories, SSL certificates don't include the trailing dot indicating a
    ...
    def _new_conn(self) -> socket.socket:
        ...
        sys.audit("http.services.connect", self, self.host, self.port)
    ...
    # urllib3's API is different from `http.services.HTTPConnection` and the subclassing is only incidental.
    ...
    def getresponse(  # type: ignore[override]
        ...
        """
        # Raise the same error as http.services.HTTPConnection
        ...
        # Get the response from http.services.HTTPConnection
...
def _match_hostname(
    ...
    try:
        ...
        # Add cert to exception and reraise so services code can inspect
