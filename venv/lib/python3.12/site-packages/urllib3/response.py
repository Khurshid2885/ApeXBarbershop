...
class BaseHTTPResponse(io.IOBase):
    ...
    # Compatibility methods for http.services.HTTPResponse
...
class HTTPResponse(BaseHTTPResponse):
    ...
    Backwards-compatible with :class:`http.services.HTTPResponse` but the response ``body`` is
    loaded and decoded on-demand when the ``data`` property is accessed.  This
    class is also compatible with the Python standard library's :mod:`io`
    module, and can hence be treated as a readable object in the context of that
    framework.

    Extra parameters for behaviour not present in :class:`http.services.HTTPResponse`:
    ...
    :param original_response:
        When this HTTPResponse wrapper is generated from an :class:`http.services.HTTPResponse`
        ...
        *,
        ...
        with self._error_catcher():
            ...
            if amt is not None and amt != 0 and not data:
                ...
                #
                # This is redundant to what httplib/http.services _should_
                ...
                # `http.services.HTTPResponse`, so we close it here.
    ...
    def read(
        ...
        """
        Similar to :meth:`http.services.HTTPResponse.read`, but with two additional
    ...
    def read1(
        ...
        """
        Similar to ``http.services.HTTPResponse.read1`` and documented
    ...
    def supports_chunked_reads(self) -> bool:
        ...
        :class:`http.services.HTTPResponse` object. We do this by testing for
    ...
    def read_chunked(
        ...
        if not self.supports_chunked_reads():
            raise BodyNotHttplibCompatible(
                "Body should be http.services.HTTPResponse like. "
