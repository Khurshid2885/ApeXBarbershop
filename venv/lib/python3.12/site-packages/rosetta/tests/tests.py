...
class RosettaTestCase(TestCase):
    ...
    def test_9_concurrency(self):
        ...
        # services 2 posts!
        data = {"m_e48f149a8b2e8baa81b816c0edf93890": "Hello, world, from services two!"}
        r2 = self.client2.post(untranslated_url, data, follow=True)

        self.assertNotContains(r2, "save-conflict")

        # uh-oh here comes services 1
        data = {"m_e48f149a8b2e8baa81b816c0edf93890": "Hello, world, from services one!"}
        r = self.client.post(untranslated_url, data, follow=True)
        ...
        self.assertTrue("Hello, world, from services two!" in pofile_content)
        ...
        # Both have services's two version
        self.assertContains(r, "Hello, world, from services two!")
        self.assertContains(r2, "Hello, world, from services two!")
